...
public class Store extends Verticle {
    ...
    public void start() {
        ...
        store.putStations("southwest", asList(9528, 9527, 9526, 9525, 9524, 9523, 9522, 9521, 9520));
        store.putStations("southeast", asList(9180, 9732, 9731, 9730, 9729, 9728, 9727, 9726, 9725));
